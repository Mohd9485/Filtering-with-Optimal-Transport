...
# -*- coding: utf-8 -*-
"""
Created on Mon Aug  7 16:14:12 2023
...
# -*- coding: utf-8 -*-
"""
Created on Sun Jul  9 16:48:05 2023
...
def OT(X,Y,X0_const,parameters,A,h,t,tau,Noise,h_index,r):
...
#                 
#                 z = A(x.to(device)).to('cpu').detach().reshape(-1,28,28)
...
# =============================================================================
            Z = A(X0.to(device)).to('cpu').detach().reshape(-1,28,28)
...
# =============================================================================
            ...
            train(convex_f,MAP_T,X0,Y1,ITERS,LR,i+1,N+1,BATCH_SIZE,k,AVG_SIM,h_index[i])

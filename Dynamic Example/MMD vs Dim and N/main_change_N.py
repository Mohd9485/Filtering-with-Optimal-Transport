...
parameters['Final_Number_ITERATION'] = int(64*16)#*16)#*16) #int(1024) #ITERATION 
...
# =============================================================================
    ...
    X_list[J.astype('str')]= SAVE_True_X
    Y_list[J.astype('str')] = SAVE_True_Y
    X_SIR_list[J.astype('str')] = SAVE_X_SIR
    X_OT_list[J.astype('str')] = SAVE_X_OT
    X_EnKF_list[J.astype('str')] = SAVE_X_EnKF
    ...
    np.savez('data_file_change_N.npz',\
        time = t,  Noise=Noise,JJ=JJ,running_time=running_time,X_list = X_list, Y_list = Y_list,\
